...
public abstract class StuckInBodyRenderTypeLayer<T extends LivingEntity, M extends PlayerRenderModel<T>> extends LayerRenderer<T, M> {
  public StuckInBodyRenderTypeLayer(LivingRenderer<T, M> p_i226041_1_) {
    super(p_i226041_1_);
  }
